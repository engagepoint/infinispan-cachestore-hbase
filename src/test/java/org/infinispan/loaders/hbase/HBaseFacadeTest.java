...
public class HBaseFacadeTest {
   ...
   public void writeAndScanMessageData() throws HBaseException {
      ...
      HBaseResultScanIterator scan = HBF.scan(TABLE_MESSAGE, COL_FAMILY_DATA, QUANTIFIER_VALUE);
      while (scan.hasNext()) {
         Entry<String, byte[]> entry = scan.next();
   ...
   public void readRowsAndDelete() throws HBaseException {
      ...
      HBaseResultScanIterator resultIterator = HBF.readRows(TABLE_MESSAGE, EXP_KEY_PREFIX, tsBase + 3, COL_FAMILY_EXP, EXP_VALUE_FIELD);
      ...
      resultIterator = HBF.readRows(TABLE_MESSAGE, EXP_KEY_PREFIX, tsBase + 100, COL_FAMILY_EXP, EXP_VALUE_FIELD);
